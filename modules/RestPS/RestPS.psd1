#
# Module manifest for module 'RestPS'
#
...
@{
    ...
    RootModule        = 'RestPS.psm1'

    # Version number of this module.
    ModuleVersion     = '7.0.44'

    # Supported PSEditions
    # CompatiblePSEditions = @()

    # ID used to uniquely identify this module
    GUID              = 'bce241ce-26a2-4807-875a-2e076f7e6662'
    ...
    RequiredModules   = @(
        @{"ModuleName" = "PowerLumber"; "ModuleVersion" = "5.0.0" }
    )
    ...
    FunctionsToExport = @('Disable-SSLValidation','Invoke-DeployRestPS','Start-RestPSListener')
